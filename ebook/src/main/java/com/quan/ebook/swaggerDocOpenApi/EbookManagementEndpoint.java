...
public interface EbookManagementEndpoint {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "The list of books", content = @Content(schema = @Schema(implementation = List.class))),
        ...
        @ApiResponses({
                        ...
                        @ApiResponse(responseCode = "400", description = "Book not found", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
                        @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
